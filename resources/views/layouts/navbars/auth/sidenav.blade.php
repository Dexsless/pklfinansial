<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('home') }}"
            ...
            <span class="ms-1 font-weight-bold">Finansial<strong style="color: yellowgreen;">Ku</strong></span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'Tabungan') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'tabungan']) }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'Keuangan') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'Keuangan']) }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        {{-- <i class="ni ni-bullet-list-67 text-dark text-sm opacity-10"></i> --}}
