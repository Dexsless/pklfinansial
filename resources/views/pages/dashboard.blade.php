...
@section('content')
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Bank</p>
                                    <h5 class="font-weight-bolder">
                                        Rp. @foreach ($keuangan as $item)
                                        {{$item->Bank}}
                                    @endforeach
                                    ...
                                    <p class="mb-0">
                                        <span class="text-danger text-sm font-weight-bolder">Rp. 0</span>
                                        since last quarter
                                    </p>
                                </div>
                            </div>
    ...
    <div class="fixed-plugin">
        <a class="fixed-plugin-button text-dark position-fixed px-2 py-2" style="border-radius: 10px; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;font-size:20px; background-color:sandybrown;">
            Tambah uang
        </a>
        <div class="card shadow-lg">
            <div class="card-header pb-0 pt-3 ">
                <div class="float-start">
                    <h5 class="mt-3 mb-0">Tambah Uang</h5>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                        ...
                        {{-- <div class="card-header">Data genre
                            <a href="{{route('keungan.index')}}" class="btn btn-sm btn-primary" style="float: right">Kembali</a>
                        </div> --}}
                        <div class="card-body">
                            <form action="{{ route('keuangan.store') }}" method="post">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control @error('Cash') is-invalid @enderror" name="Cash">
                                    @error('Cash')
